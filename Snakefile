...
rule basecalling:
    ...
    params:
        genome = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/reference/GCF_016746395.2_Prin_Dsim_3.1_genomic.fna.gz',
        outdir = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/'
    threads: 25
    resources:
        slurm_partition='gpu',
...
rule sort_bam:
    input:
        bam = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/aligned_basecalled.bam'
    output:
        sorted_bam = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/aligned_basecalled.sorted.bam',
        index = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/aligned_basecalled.sorted.bam.bai'
    resources: 
        mem_mb=100000,
        runtime=200
    threads: 16  
...
rule separate_bam:
    input:
        bam = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/aligned_basecalled.sorted.bam',
    output:
        host_bam = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/{sample}.DsimM23.bam',
        wolbachia_bam = '/private/groups/russelllab/jodie/Jacobs_et_al_2026_de_novo_wRi_merrill_23_assembly/data/aligned/{sample}.wRiM23.bam'
    resources: 
        mem_mb=100000,
        runtime=200
    threads: 8  
